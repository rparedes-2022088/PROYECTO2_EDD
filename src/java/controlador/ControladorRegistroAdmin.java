...
public class ControladorRegistroAdmin extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int idRol = Integer.parseInt(request.getParameter("select"));
        ...
        int idGenerado = nuevo.registrarUsuario(nuevo);
        ...
        if(idGenerado > 0){
            ...
            int posicionHash = memoria.bddUsuarios.insertar(nuevo.getIdUsuario(), nuevo);
            
            memoria.indiceArbol.insertar(nuevo.getIdUsuario(), posicionHash);
